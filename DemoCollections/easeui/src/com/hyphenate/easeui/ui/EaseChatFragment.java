...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    static final int ITEM_SENDVEDIO = 4;
    ...
    protected int[] itemIds = { ITEM_TAKE_PICTURE, ITEM_PICTURE, ITEM_SENDVEDIO};
    ...
    private void startRecord(){
        MediaRecorderConfig config = new MediaRecorderConfig.Buidler()
                ...
                .build();
        MediaRecorderActivity.afterSmallVideoRecorder(getActivity(), config);
    }

    public void sendVedioMessage(String filePath,String thumbPath,int videoLenght){
        sendVideoMessage(filePath,thumbPath,videoLenght);
    }
