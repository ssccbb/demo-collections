...
public class MediaRecorderActivity extends Activity implements
    ...
    public static void goSmallVideoRecorder(Activity context, String overGOActivityName, MediaRecorderConfig mediaRecorderConfig) {
        context.startActivityForResult(new Intent(context, MediaRecorderActivity.class).putExtra(OVER_ACTIVITY_NAME, overGOActivityName).putExtra(MEDIA_RECORDER_CONFIG_KEY, mediaRecorderConfig),0);
    }

    public static void afterSmallVideoRecorder(Activity context, MediaRecorderConfig mediaRecorderConfig) {
        context.startActivityForResult(new Intent(context, MediaRecorderActivity.class).putExtra(MEDIA_RECORDER_CONFIG_KEY, mediaRecorderConfig),0);
    }
...
//		TODO 开始录制的图标
    ...
    public void onEncodeComplete() {
        ...
        if (getIntent().getStringExtra(OVER_ACTIVITY_NAME)==null){
            ...
            try {
                intent.setClass(this, Class.forName(getIntent().getStringExtra(OVER_ACTIVITY_NAME)));
